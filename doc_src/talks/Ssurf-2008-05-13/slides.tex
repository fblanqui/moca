...
\newslide{The new Moca enhancements}
...
The implementation part is shorter term and practical. It is also well understood.
...
\newslide{Implementation: the automatic test generation}
...
\newslide{Research: generation of complex rules}
\advitransition{wipe}
...
\newslide{A data types {\em impedimenta} generator}
\advitransition{wipe}
