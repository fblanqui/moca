...
(* $Id: warnings.ml,v 1.7 2011-11-03 07:23:48 weis Exp $ *)
...
let print ppf w =
  ...
  Format.pp_set_all_formatter_output_functions ppf
    ~out:out ~flush:flush ~newline:countnewline ~spaces:spaces;
  Format.fprintf ppf "%d: %s%!" num msg;
  Format.pp_set_all_formatter_output_functions ppf
    ~out:out ~flush:flush ~newline:newline ~spaces:spaces;
