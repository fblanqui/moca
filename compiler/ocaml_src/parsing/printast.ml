...
(* $Id: printast.ml,v 1.14 2011-10-18 08:59:35 weis Exp $ *)
...
and string_x_core_type_list_x_location i ppf (s, l, _relations, loc) =
  line i ppf "\"%s\" %a\n" s fmt_location loc;
  list (i+1) core_type ppf l;

and string_x_mutable_flag_x_core_type_x_location i ppf (s, mf, ct, _relations, loc) =
  line i ppf "\"%s\" %a %a\n" s fmt_mutable_flag mf fmt_location loc;
  core_type (i+1) ppf ct;
