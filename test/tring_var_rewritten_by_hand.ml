...
(* $Id: tring_var_rewritten_by_hand.ml,v 1.1 2010-12-17 10:36:11 weis Exp $ *)
...
+ ledit -h /home/beaujolais/weis/.ocaml-history -x ocaml gentest.cmo ring_var_rewritten_by_hand.cmo
...
open Ring_var_rewritten_by_hand;;

testing "Ring_var_rewritten_by_hand"
;;
...
testl 110
 (try
    let x0 = opp (add_list [var "30"; var "28"; var "63"; ]) in
    let x1 = var "46" in
    let x2 =
      add_list [
        mul_list [ var "41"; var "10"; var "41"; ];
        mul_list [ var "24"; var "49"; var "56"; ];
        var "28";
      ] in

    mul_list [ x0; x1; add_list [ x0; x1; x2; ]; x2; ] =
    add_list [
      mul_list [x0; x1; x0; x2];
      mul_list [x0; x1; x1; x2];
      mul_list [x0; x1; x2; x2];
    ]
  with
  | Failure "Division by Absorbent" -> true)
;;
